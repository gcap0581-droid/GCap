      ...
      <div className="relative w-full max-w-xs sm:max-w-sm bg-slate-900 border-r border-slate-800 h-full flex flex-col shadow-2xl z-10 overflow-hidden text-slate-100">
        ...
        {currentUser && (
          ...
          >
            <div className="flex items-center gap-2 min-w-0">
              <div className="w-8 h-8 rounded-lg bg-cyan-500/20 text-cyan-400 flex items-center justify-center font-bold text-sm shrink-0 group-hover:bg-cyan-500/30 transition-colors">
                {currentUser.name ? currentUser.name.charAt(0).toUpperCase() : 'U'}
              </div>
              <div className="min-w-0">
                <div className="text-sm font-bold text-white truncate group-hover:text-cyan-300 transition-colors flex items-center gap-1">
                  <span>{currentUser.name}</span>
                  <span className="text-[12px] text-cyan-400">⚙️</span>
                </div>
        ...
        <div className="p-3 bg-slate-950/90 border-b border-slate-800">
          <button
            ...
            className="w-full py-2.5 px-3 rounded-xl bg-gradient-to-r from-emerald-600/30 via-emerald-500/20 to-teal-600/30 hover:from-emerald-600/40 hover:to-teal-600/40 border border-emerald-500/40 text-emerald-300 font-black text-xs flex items-center justify-center gap-2 transition-all cursor-pointer shadow-md active:scale-95"
          >
            <RefreshCw className="w-4 h-4 text-emerald-400" />
            <span>{isHi ? '🔄 डेटा सिंक व ऐप रिफ्रेश करें' : '🔄 Sync & Refresh App'}</span>
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-2 scrollbar-thin scrollbar-thumb-slate-800">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-950/50 overflow-hidden">
            <button
              ...
              className="w-full px-3.5 py-2.5 flex items-center justify-between text-left font-bold text-sm text-white hover:bg-slate-800/50 transition-colors"
            >
            ...
            {expandedMenu === 'wallet' && (
              <div className="px-3 pb-2.5 pt-1 space-y-1 bg-slate-950/80 border-t border-slate-800/80">
                <button
                  ...
                  className="w-full text-left px-3 py-2 rounded-lg text-sm flex items-center justify-between text-slate-300 hover:bg-slate-800/60 transition-colors"
                >
                  <div className="flex items-center gap-2">
                    <PlusCircle className="w-4 h-4 text-emerald-400" />
                    <span>{isHi ? 'पैसे जोड़ें (Deposit via UPI/QR)' : 'Deposit Funds (UPI/QR)'}</span>
                  </div>
                  <span className="text-[11px] text-emerald-400 font-bold">0% Fee</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[11px] text-purple-300 font-bold">24x7</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[11px] text-amber-400 font-mono">1:1</span>
                </button>
            ...
            {expandedMenu === 'rules' && (
              <div className="px-3 pb-2.5 pt-1 space-y-1 bg-slate-950/80 border-t border-slate-800/80">
                ...
                >
                  ...
                  <span className="text-[11px] text-emerald-400 font-bold">100% Safe</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[11px] text-amber-400 font-mono">PDF</span>
                </button>
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2 rounded-lg text-sm flex items-center justify-between text-cyan-300 hover:bg-slate-800/60 transition-colors font-semibold"
                >
                  <div className="flex items-center gap-2">
                    <Building2 className="w-4 h-4 text-cyan-400" />
                    <span>{isHi ? '🏛️ सरकारी TDS रिफंड प्रक्रिया गाइड PDF' : '🏛️ Govt TDS Refund Process PDF'}</span>
                  </div>
                  <span className="text-[11px] bg-cyan-500/20 text-cyan-300 font-mono px-1.5 py-0.5 rounded border border-cyan-500/30">
                    ITR
                  </span>
                </button>
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2 rounded-lg text-sm flex items-center justify-between text-emerald-300 hover:bg-slate-800/60 transition-colors font-semibold"
                >
                  <div className="flex items-center gap-2">
                    <BookOpen className="w-4 h-4 text-emerald-400" />
                    <span>{isHi ? '📖 GCap संचालन SOP एवं यूज़र मैन्युअल' : '📖 GCap Operations SOP & User Manual'}</span>
                  </div>
                  <span className="text-[11px] bg-emerald-500/20 text-emerald-300 font-mono px-1.5 py-0.5 rounded border border-emerald-500/30">
                    SOP
                  </span>
                </button>
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2 rounded-lg text-sm flex items-center justify-between text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 transition-colors font-bold"
                >
                  <div className="flex items-center gap-2">
                    <FileText className="w-4 h-4 text-amber-400" />
                    <span>{isHi ? '📜 GCap & निवेशक कानूनी अनुबंध (PDF)' : '📜 GCap & Investor Agreement (PDF)'}</span>
                  </div>
                  <span className="text-[11px] bg-amber-500 text-slate-950 font-bold px-1.5 py-0.5 rounded">
                    LEGAL
                  </span>
                </button>
              </div>
            ...
            {expandedMenu === 'rewards' && (
              <div className="px-3 pb-2.5 pt-1 space-y-1 bg-slate-950/80 border-t border-slate-800/80">
                ...
                >
                  ...
                  <span className="text-[11px] text-amber-400 font-bold">5% + 2%</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[11px] bg-emerald-500/20 text-emerald-300 px-1.5 py-0.5 rounded font-mono">APK</span>
                </a>
              </div>
            )}
          </div>
        ...
        <div className="p-3.5 border-t border-slate-800 bg-slate-950 space-y-2.5">
          ...
          {/* Refresh App & Sync Button */}
          <button
            onClick={() => {
              window.location.reload();
            }}
            className="w-full py-2 px-3 rounded-lg bg-emerald-500/15 hover:bg-emerald-500/25 border border-emerald-500/35 text-emerald-300 text-sm font-bold flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm active:scale-95"
          >
            <RefreshCw className="w-4 h-4 text-emerald-400" />
            <span>{isHi ? '🔄 डेटा सिंक व रिफ्रेश करें (Refresh App)' : '🔄 Sync & Refresh App'}</span>
          </button>
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="py-2 px-2.5 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-300 text-sm font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="py-2 px-2.5 rounded-lg bg-slate-850 hover:bg-slate-800 border border-slate-700 text-sm font-semibold flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
            >
              {viewMode === 'web' ? (
                <>
                  <Smartphone className="w-4 h-4 text-emerald-400" />
          ...
          {onOpenSplashIntro && (
            <button
              ...
              className="w-full py-2 px-3 rounded-lg bg-gradient-to-r from-emerald-500/15 via-amber-500/15 to-emerald-500/15 hover:from-emerald-500/25 hover:to-amber-500/25 border border-emerald-500/40 text-emerald-300 text-sm font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-sm"
            >
          ...
          <button
            ...
            className="w-full py-2 px-3 rounded-lg bg-amber-500/15 hover:bg-amber-500/25 border border-amber-500/30 text-amber-300 text-sm font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer disabled:opacity-50"
          >
            <Zap className={`w-4 h-4 ${isSimulating ? 'animate-spin' : 'text-amber-400 fill-amber-400'}`} />
          ...
          {currentUser && onLogout && (
            <button
              ...
              className="w-full py-2 px-3 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/30 text-rose-300 text-sm font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
            >
