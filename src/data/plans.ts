...
export const INVESTMENT_PLANS: InvestmentPlan[] = [
  {
    ...
    dailyRoiPercent: 0.160, // 0.040% every 6 hours (0.040% * 4 = 0.160% per day)
    durationDays: 641,
    ...
    description: 'Special 641-day Short Term investment plan. Minimum deposit ₹1,00,000 to Unlimited. First 24 hours lock. Earn 0.040% of your investment amount every 6 hours as GP (1 GP = ₹1) automatically credited to Total Earning.',
    descriptionHi: 'विशेष 641 दिवसीय शॉर्ट टर्म निवेश योजना। न्यूनतम निवेश ₹1,00,000 से असीमित (Unlimited)। पहले 24 घंटे का लॉक। हर 6 घंटे में निवेश राशि का 0.040% GP (1 GP = ₹1) स्वतः Total Earning में जमा होता रहेगा।',
    features: [
      'न्यूनतम निवेश ₹1,00,000 से अधिकतम असीमित (Unlimited)',
      'परिपक्वता अवधि 641 दिन (पहले 24 घंटे का लॉक)',
      'हर 6 घंटे में निवेश राशि का 0.040% GP लाभ (1 GP = ₹1)',
  ...
  },
  {
    ...
    dailyRoiPercent: 0.132, // 0.033% every 6 hours (0.033% * 4 = 0.132% per day)
    durationDays: 365,
    ...
    description: 'Premier 365-day Long Term Plan with Royalty pathway. Deposit ₹10,000 to ₹1,00,000. First 24 hours lock. Earn 0.033% of your invested amount every 6 hours as GP (1 GP = ₹1) credited automatically to Total Earning.',
    descriptionHi: 'प्रीमियम 365-दिवसीय लॉन्ग टर्म निवेश एवं रॉयल्टी योजना। निवेश सीमा ₹10,000 से ₹1,00,000 तक। पहले 24 घंटे का लॉक। हर 6 घंटे में निवेश राशि का 0.033% GP (1 GP = ₹1) स्वतः Total Earning में जमा होगा + रॉयल्टी पाथवे।',
    features: [
      'न्यूनतम निवेश ₹10,000 एवं अधिकतम ₹1,00,000',
      'अवधि 365 दिन (पहले 24 घंटे का लॉक)',
      'हर 6 घंटे में निवेश राशि का 0.033% GP (1 GP = ₹1) स्वतः जमा',
