...
export const INVESTMENT_PLANS: InvestmentPlan[] = [
  {
    ...
    dailyRoiPercent: 0.16, // 0.04% every 6 hours (0.04% * 4 = 0.16% per day)
    durationDays: 641,
    ...
    description: 'Special 641-day Short Term investment plan. Minimum deposit ₹1,00,000 (No maximum limit). Locked for 641 days. Earn 0.04% of your investment amount every 6 hours as GP (1 GP = ₹1) automatically credited to Total Earning. Withdraw earnings as per company withdrawal dates. At 641 days maturity, choose to renew with same Plan ID or withdraw full principal + remaining earnings with an official Certificate.',
    descriptionHi: 'विशेष 641 दिवसीय शॉर्ट टर्म निवेश योजना। न्यूनतम निवेश ₹1,00,000 (अधिकतम की कोई सीमा नहीं)। मूलधन 641 दिनों तक सुरक्षित लॉक रहेगा। लॉक पीरियड में हर 6 घंटे में निवेश राशि का 0.04% GP (1 GP = ₹1) स्वतः Total Earning में जमा होता रहेगा। कंपनी के निकासी नियमों (1 से 5 तारीख) के तहत अर्निंग निकाली जा सकती है। 641 दिन पूरे होने पर उसी Plan ID से पुनः रिन्यू करें अथवा पूरा मूलधन व शेष लाभ निकालें और आधिकारिक परिपक्वता प्रमाण पत्र प्राप्त करें।',
    features: [
      'न्यूनतम निवेश ₹1,00,000 (अधिकतम निवेश की कोई सीमा नहीं / Unlimited)',
      'परिपक्वता अवधि 641 दिन (पूंजी 641 दिनों तक सुरक्षित लॉक)',
      'हर 6 घंटे में निवेश राशि का 0.04% GP लाभ (1 GP = ₹1)',
  ...
  },
  {
    ...
    dailyRoiPercent: 0.12, // 0.03% every 6 hours (0.03% * 4 = 0.12% per day)
    durationDays: 365,
